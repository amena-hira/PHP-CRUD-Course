...
<body>
    ...
    <h3 class="text-center text-success pb-3"> Assign Course to Studdent </h3>
        ...
        <div class="form-row">
          ...
          <input type="hidden" name="status" class="txtField" value="Done">
            <div class="form-group col-md-6">
                <label for="inputEmail4">Student ID</label>
                <input type="text" name="students_id" class="form-control" id="inputEmail4" placeholder="Student ID" value="<?php echo $row['student_id']; ?>">
            </div>
            <div class="form-group col-md-6">
                <label for="inputEmail4">Student Name</label>
                <input type="text" name="student_name" class="form-control" id="inputEmail4" placeholder="Student ID" value="<?php echo $row['student_name']; ?>">
            </div>
            <div class="form-group col-md-6">
        ...
        <a href="proposal_Course.php" class="btn btn-danger">Back</a>
        </form>
